...
import com.spring.boot.demo_park_api.service.ClienteService;
import com.spring.boot.demo_park_api.service.UsuarioService;
import com.spring.boot.demo_park_api.web.dto.ClienteCreateDto;
import com.spring.boot.demo_park_api.web.dto.ClienteResponseDto;
import com.spring.boot.demo_park_api.web.dto.PageableDto;
import com.spring.boot.demo_park_api.web.dto.mapper.ClienteMapper;
...
@Tag(name = "Clientes", description = "Contém todas as operações relativas ao recurso de um cliente.") // Mover @Tag para o nível da classe
